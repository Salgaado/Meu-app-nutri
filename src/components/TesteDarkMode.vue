<!-- src/components/TesteDarkMode.vue -->
<template>
  <div
  ...
  >
    ...
    <p class="p-4 bg-white dark:bg-gray-800 rounded transition-colors">
...
function toggle() {
  ...
  console.log("[TesteDarkMode] HTML class agora:", html.className);
}
</script>
